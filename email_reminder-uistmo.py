...
#%%
df_rt = pd.read_csv('datamasterestudianteistmo.csv', encoding='latin-1')
...
email_is_nan = df_rt[df_rt['email'].isna()]
df_rt  = df_rt[df_rt['dateOfBirth'].notnull()]
df_rt  = df_rt[df_rt['email'].notnull()]
...
time.sleep(1800)
print('pasaron 30 minutos', pd.Timestamp.today())
