...
def send_email(email,fname,card):
    ...
    html = '''
        ...
        <body lang=EN-US style='word-wrap:break-word'>
            ...
            <div class=WordSection1>
                ...
                <p class=MsoNormal align=center style='text-align:center'><span lang=ES-PA style='font-size:18.0pt;font-family:"Agency FB",sans-serif'><img width=auto
                    height=133 id="Picture 6"
                    src="cid:image3" alt="University logo"</span></p>

                <p class=MsoNormal align=center style='text-align:center'><span lang=ES-PA style='font-size:18.0pt;font-family:"Agency FB",sans-serif'>&nbsp;</span></p>

                <p class=MsoNormal align=center style='text-align:center'><span style='font-size:18.0pt;font-family:"Agency FB",sans-serif'>Estudiante de la
                Universidad Santa Maria La Antigua de Panamá</span></p>
    ...
    date_str = pd.Timestamp.today().strftime("%m/%d/%Y, %H:%M:%S")

    # Create a MIMEMultipart class, and set up the From, To, Subject fields
    email_message = MIMEMultipart()
    email_message['From'] = "USMA <no-reply@otecviajespanama.com>"
    email_message['To'] = email_to
    email_message['Bcc'] = ', '.join(bcc)
    email_message['Subject'] = f'USMA - '''+card
    ...
    # Display an error message if something goes wrong.  
        ...
        contador = contador - 1
        with open('emails_fallido.csv', 'a') as csv_file:
        ...
        contador = contador - 1
        print(contador)
        with open('emails_sent.csv', 'a') as csv_file:
            dict_object = csv.DictWriter(csv_file, fieldnames=field_names)
            dict_object.writerow(dict)
      
#%%
send_email("mdominguezc@usma.com.pa","DOMINGUEZ, MARIA","S 507 000 038 223 J")

#%%
print(lista_util)
#%%
send_email("gafafong99@gmail.com","Gomez, Vielka","445465346546456")
#%%

#%%
df_rt = pd.read_csv('email.csv', encoding='utf-8')
#%%
...
df_rt2 = pd.read_csv('dataemailmaster.csv', encoding='latin-1')
df_rt3 = pd.read_csv('emails_sent.csv', encoding='latin-1')
df_rt3.columns = ['email', 'status','nan']
#%%
df_rt3= df_rt3['email'].unique()
#%%
merge_df= pd.merge(df_rt2, df_rt3,on=['email'])
merge_df=merge_df.drop(['No.', 'nan'], axis=1)

merge_df.to_csv('emails_status.csv')
