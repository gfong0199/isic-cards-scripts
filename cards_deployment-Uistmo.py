...
# if df_rt['ï»¿cardNumber']:
#     print('existe')
#     df_rt.rename(columns = {'ï»¿cardNumber':'cardNumber'}, inplace = True)
# else:
#     print('no existe existe ï»¿cardNumber')
...
def data_loader(card):
        ...
        response_post = requests.post(url, headers=headers,
                                auth=HTTPBasicAuth('ccdb-ws-udelistmo-pa','97gCgp-iDIBml'),
                                data=encoded_data)
...
def main():
    ...
    send_email("vielka.gomez@otec.com.pa"," Universidad Del istmo")
