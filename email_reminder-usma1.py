...
def send_email(email,fname,card):
    ...
    try:    
        ...
        server.ehlo()  
        server.login(email_from, password)
        server.sendmail(email_from, (email_to,bcc), email_string) 
        server.close()  
...
#%%
send_email("gafafong99@gmail.com","Guillermo Fong","5151341654168453")
...
#%%
df_rt = pd.read_csv('dataemail1.csv', encoding='latin-1')
